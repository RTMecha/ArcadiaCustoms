...
namespace ArcadiaCustoms.Functions
{
    public class ArcadeMenu : MonoBehaviour
    {
        ...
        public static List<int> SelectionLimit { get; set; } = new List<int>();
        ...
        public IEnumerator SetupScene()
        {
            ...
            // Local
            {
                ...
                // Settings
                {
                    ...
                    UIManager.SetRectTransform(prevPage.GetObject<RectTransform>(), new Vector2(300f, 0f), ZeroFive, ZeroFive, ZeroFive, new Vector2(232f, 100f));
                    ...
                    prevPageText.GetObject<TextMeshProUGUI>().text = "Previous";
                    ...
                    UIManager.SetRectTransform(pageField.GetObject<RectTransform>(), new Vector2(550f, 0f), ZeroFive, ZeroFive, ZeroFive, new Vector2(250f, 100f));
                    ...
                    this.pageField.text = "0";

                    var nextPage = UIManager.GenerateUIImage("Next", localSettingsBar.GetObject<RectTransform>());
                    UIManager.SetRectTransform(nextPage.GetObject<RectTransform>(), new Vector2(800f, 0f), ZeroFive, ZeroFive, ZeroFive, new Vector2(232f, 100f));
                    ...
                    nextPageText.GetObject<TextMeshProUGUI>().text = "Next";
                    ...
                    prevPageClickable.onClick = delegate (PointerEventData pointerEventData)
                    {
                        ...
                        {
                            this.pageField.text = (Mathf.Clamp(CurrentPage[0] - 1, 0, LevelManager.Levels.Count)).ToString();
                        }
                    };
                    ...
                    RTHelpers.AddEventTriggerParams(pageField.GetObject<GameObject>(), RTHelpers.ScrollDeltaInt(this.pageField, max: int.MaxValue));
                }
                ...
                // Prefab
                {
                    ...
                    var shine = Resources.FindObjectsOfTypeAll<GameObject>().ToList()
                        .Find(x => x.name == "Button" && x.transform.Find("shine")).transform.Find("shine").gameObject
                ...
                var searchFieldIF = searchField.GetObject<InputField>();
                searchFieldIF.onValueChanged.ClearAll();
                searchFieldIF.textComponent.alignment = TextAnchor.MiddleLeft;
                searchFieldIF.textComponent.color = textColor;
                searchFieldIF.onValueChanged.AddListener(delegate (string _val)
                {
                    SearchTerm = _val;
                });
            }
