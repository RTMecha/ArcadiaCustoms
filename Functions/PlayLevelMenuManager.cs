...
namespace ArcadiaCustoms.Functions
{
    public class PlayLevelMenuManager : MonoBehaviour
    {
        ...
        public IEnumerator SetupPlayLevelMenu()
        {
            ...
            // Play
            {
                ...
                play.Clickable.onClick = delegate (PointerEventData pointerEventData)
                {
                    ...
                    ArcadePlugin.inst.StartCoroutine(LevelManager.Play(CurrentLevel));
                };
        ...
        public void OpenSettings()
        {
            ...
            var animation = new AnimationManager.Animation("Open Settings Animation");
        ...
        public void CloseSettings()
        {
            ...
            var animation = new AnimationManager.Animation("Close Settings Animation");
            animation.floatAnimations = new List<AnimationManager.Animation.AnimationObject<float>>
            {
                new AnimationManager.Animation.AnimationObject<float>(new List<IKeyframe<float>>
                {
        ...
        {
            Debug.Log($"{ArcadePlugin.className}Set level: {level.metadata.song.title}");
            animating = true;
            CurrentLevel = level;
            ...
            var d = RTHelpers.GetDifficulty(level.metadata.song.difficulty);
        ...
        public void Close()
        {
            ...
            var animation = new AnimationManager.Animation("Close Play Level Menu Animation");
            animation.floatAnimations = new List<AnimationManager.Animation.AnimationObject<float>>
            {
                new AnimationManager.Animation.AnimationObject<float>(new List<IKeyframe<float>>
                {
